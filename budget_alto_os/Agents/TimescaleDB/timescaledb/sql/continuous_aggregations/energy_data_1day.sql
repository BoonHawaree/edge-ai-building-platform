-- Create a continuous aggregate for the energy_data_1day materialized view
CREATE MATERIALIZED VIEW IF NOT EXISTS energy_data_1day
...
SELECT
    ...
    device_id,
    CASE
        WHEN datapoint = 'cumulative_energy' THEN 'daily_energy'
        WHEN datapoint = 'cumulative_cooling_energy' THEN 'daily_cooling_energy'
    END AS datapoint,
...
SELECT add_continuous_aggregate_policy('energy_data_1day',
