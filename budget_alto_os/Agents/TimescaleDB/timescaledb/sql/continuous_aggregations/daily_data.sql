-- Create a continuous aggregate for the daily_data materialized view
CREATE MATERIALIZED VIEW IF NOT EXISTS daily_data
...
SELECT
    ...
    CASE
        ...
        WHEN datapoint IN (
            ...
            'compressor_3_status', 'flow_rate_write'
...
-- Add refresh policy that runs every day
SELECT add_continuous_aggregate_policy('daily_data',
