-- Create a continuous aggregate for the aggregated_data_1hour materialized view
CREATE MATERIALIZED VIEW IF NOT EXISTS aggregated_data_1hour
...
SELECT add_continuous_aggregate_policy('aggregated_data_1hour',
