-- Create a continuous aggregate for the statistic_data_1month materialized view
CREATE MATERIALIZED VIEW IF NOT EXISTS statistic_data_1month
...
SELECT add_continuous_aggregate_policy('statistic_data_1month',
