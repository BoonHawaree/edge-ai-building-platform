-- Create a continuous aggregate for the aggregated_data_1day materialized view
CREATE MATERIALIZED VIEW IF NOT EXISTS aggregated_data_1day
...
SELECT add_continuous_aggregate_policy('aggregated_data_1day',
