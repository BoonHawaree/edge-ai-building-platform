-- Create a continuous aggregate for the aggregated_data materialized view
CREATE MATERIALIZED VIEW IF NOT EXISTS aggregated_data
...
SELECT
    ...
    CASE
        ...
        WHEN datapoint IN (
            ...
            'compressor_3_status', 'flow_rate_write', 'fan_speed_write', 'fan_speed', 'fan_mode_read', 'fan_mode_write', 'mode_read', 'mode_write',
...
-- Add refresh policy that runs every minute
SELECT add_continuous_aggregate_policy('aggregated_data',
